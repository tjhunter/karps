...
# ****************
# This file is a copy of the following file:
# https://github.com/apache/spark/blob/master/python/pyspark/sql/types.py
#
# This was done so that all the code can be hosted onty PyPI without 
# relying on PySpark being installed.

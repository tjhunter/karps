...
instance (a ~ Proto.Karps.Proto.Profiling.ComputationTrace,
          b ~ Proto.Karps.Proto.Profiling.ComputationTrace,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "computationTrace" f ComputationStreamResponse
         ComputationStreamResponse a b where
        lensOf _
          = (Prelude..)
              (Lens.Family2.Unchecked.lens
...
instance (a ~
          ...
          b ~ Prelude.Maybe Proto.Karps.Proto.Profiling.ComputationTrace,
          Prelude.Functor f) =>
         Lens.Labels.HasLens "maybe'computationTrace" f
         ComputationStreamResponse ComputationStreamResponse a b where
        lensOf _
          = (Prelude..)
              (Lens.Family2.Unchecked.lens
                ...
                computationTrace__field_descriptor
                  = Data.ProtoLens.FieldDescriptor "computation_trace"
                      (Data.ProtoLens.MessageField ::
                         Data.ProtoLens.FieldTypeDescriptor
                           Proto.Karps.Proto.Profiling.ComputationTrace)
                      (Data.ProtoLens.OptionalField maybe'computationTrace)
                      :: Data.ProtoLens.FieldDescriptor ComputationStreamResponse
              in
              Data.ProtoLens.MessageDescriptor
                ...
                (Data.Map.fromList
                   [("session", session__field_descriptor),
                    ...
                    ("computation_trace", computationTrace__field_descriptor)])
...
computationTrace ::
                 forall f s t a b .
                   Lens.Labels.HasLens "computationTrace" f s t a b =>
                   Lens.Family2.LensLike f s t a b
computationTrace
  = Lens.Labels.lensOf
...
maybe'computationTrace ::
                       forall f s t a b .
                         Lens.Labels.HasLens "maybe'computationTrace" f s t a b =>
                         Lens.Family2.LensLike f s t a b
maybe'computationTrace
  = Lens.Labels.lensOf
      ((Lens.Labels.proxy#) ::
